...
public class RunRepository {
    ...
    // Looking at the class path, Spring will automatically
    // configure a jdbcClient, and it will be in the
    // application context and autowired when requested.
    ...
    public void delete(Integer id) {
        var updated = jdbcClient.sql("delete from where id = :id").param("id", id).update();
